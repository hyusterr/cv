...
- Decision-oriented Text Evaluation: I worked with Chung-Chi Chen to develop a decision-oriented text evaluation method, which focuses on finding an alternative evaluation method for market commentary generation.\\
