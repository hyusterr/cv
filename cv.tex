...
\par}%
  \hskip -12em{
    \href{\authorwww}{LinkedIn}
%    \authorwww
\par}%
\hskip -12em{
    \href{\authorgooglescholar}{Google Scholar}
\par}%
%  \hskip -12em{
%    \authoraddress
% \par}%
...
\newcommand{\authorgooglescholar}[0]{https://scholar.google.com.tw/citations?user=5w3AhiMAAAAJ}
...
\section{Positions}
\noindent\textbf{National Institute of Informatics (NII)}\hfill Visiting Researcher\\
Tokyo, Japan\hfill July 2026-present\\\\
Selected as a recipient of the Graduate Students Study Abroad Program sponsored by the National Science and Technology Council (NSTC) to conduct 12 months of advanced research at NII.\\

\noindent\textbf{National Institute of Advanced Industrial Science and Technology (AIST)}\hfill Visiting Intern\\
Tokyo, Japan\hfill January 2025-March 2025\\\\
- Decision-oriented Text Evaluation: I worked with Dr. Chung-Chi Chen to develop a decision-oriented text evaluation method, which focuses on finding an alternative evaluation method for market commentary generation.\\
...
\begin{verse}
\bibentry{huang2026nash}
\end{verse}
\begin{verse}
\bibentry{chiu2025emnlp}
\end{verse}
\begin{verse}
\bibentry{wang2025surf}
\end{verse}
\begin{verse}
\bibentry{lin2025betag}
\end{verse}
\begin{verse}
...
\begin{verse}
\bibentry{roodman2026detectinginformationchannelscongressional}
\end{verse}
\begin{verse}
\bibentry{huang2025fromsimilarity}
\end{verse}
\begin{verse}
\bibentry{huang2025finnue}
\end{verse}
\begin{verse}
\bibentry{huang2025finlight}
\end{verse}
\begin{verse}
\bibentry{chiu2025financial}
\end{verse}
\vspace{\baselineskip}
\noindent\textbf{Preprints}\\
\begin{verse}
\bibentry{huang2025decisionorientedtextevaluation}
\end{verse}
\vspace{1em}
\section{Recognition}
\noindent\textbf{Awards}\\
Graduate Students Study Abroad Program Grant, National Science and Technology Council, 2026\\
Student Travel Grant, GenAI in Finance Workshop at NeurIPS 2025, 2025\\
