...
\section{Positions}
\noindent\textbf{National Institute of Advanced Industrial Science and Technology (AIST)}\hfill Visiting Researcher\\
Tokyo, Japan\hfill January 2025-March 2025\\\\
- Market Commentary Generation: Developed a LLM pipeline to generate market commentary based on financial news and stock price data.\\ - Large Language Model Research: Conducted experiments to evaluate the deficiency of LLM and Deep Research on the proposed task.\\
